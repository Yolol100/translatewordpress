...
final class AdminMenu
{
    ...
    {
        add_menu_page(
            __('Translate', 'webactueel-translate-language-dropdowns'),
            __('Translate', 'webactueel-translate-language-dropdowns'),
            'manage_options',
            self::SLUG,
            [$this, 'render'],
    ...
    public function admin_bar_menu(\WP_Admin_Bar $admin_bar): void
    {
        ...
        $admin_bar->add_node([
            'id' => 'wat-translate',
            'title' => esc_html__('Translate', 'webactueel-translate-language-dropdowns'),
            'href' => admin_url('admin.php?page=' . self::SLUG),
            'meta' => [
                'title' => esc_attr__('Open Webactueel Translate', 'webactueel-translate-language-dropdowns'),
            ],
        ]);
    }
    ...
    public function render(): void
    {
        ...
        echo '<div id="webactueel-translate-admin-root" class="webactueel-translate-admin webactueel-translate-language-dropdowns-admin"></div>';
        echo '</div>';
    }
}
